...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
			...
			.basePackage("com.org.generation.blogPessoal.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			...
			.licenseUrl("https://github.com/sylviamonteiro")
			.contact(contact())
			.build();
		
	}
	private static Contact contact() {
		return new Contact("Sylvia Monteiro	",
				"https://github.com/sylviamonteiro",
				"sylviacmmoraes@gmail.com");
	}
